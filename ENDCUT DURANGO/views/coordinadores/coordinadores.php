...
$sql = "SELECT * FROM coordinadores WHERE universidad = '" . $_SESSION['uni'] . "';";
...
$sqlPaginacion = "SELECT * FROM coordinadores WHERE universidad = '" . $_SESSION['uni'] . "' LIMIT $indiceInicio, $registrosPorPagina";
    ...
    <div id='center' class="main center">
        <div style="margin: 10%;">
            <div className="d-flex">
                <div>
                    <h1 style="font-weight:bold; font-size:4vmin">Inicio / Registro Coordinadores</h1>
                    <div>
                        <a href="#" class="AddButtonv2" id="botonAdd" onclick="toggleDiv()"><i class="fa fa-plus"></i>&nbsp;&nbsp;   Agregar registro de Coordinadores</a>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="width:400px">
                                            ...
                                            <input placeholder="Nombre del Asistente" name="nom_asistente" type="text">
                                        </td>
                                        <td>
                        ...
                        <table class="TableDesign" id="miTabla">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['nom_asistente']; ?></td>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nombre) || empty($ape_pat) || empty($ape_mat) || empty($celular) || empty($correo) || empty($nom_asistente)) {
        ...
        $query = "INSERT INTO coordinadores (universidad, nombre, ape_pat, ape_mat, celular, correo, nom_asistente, imagen) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($query);

        if ($stmt) {
            $stmt->bind_param("ssssssss", $universidad, $nombre, $ape_pat, $ape_mat, $celular, $correo, $nom_asistente, $imagenContenido);
            if ($stmt->execute()) {
                ...
                echo "<script>
                    Swal.fire({
                        ...
                        window.location.href = 'coordinadores.php'; // Redireccionar a la página principal
                    });
                </script>";
            } else {
